...
const ProductsDataTable = ({ items, onEditRow, onRowDelete, onRowClick }) => {
    ...
    return (
        <DataTable value={items} onRowClick={onRowClick} scrollable rowHover paginator rows={10}>
            <Column field="name" header="Product Name" body={pTemplate0} style={{ minWidth: "8rem" }} />
            ...
            <Column field="rating" header="Rating" body={ratingTemplate3} style={{ minWidth: "8rem" }} />
            <Column field="image" header="Image" body={imageTemplate4} style={{ minWidth: "8rem" }} />
